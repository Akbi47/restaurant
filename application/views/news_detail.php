...
<?php 
	if($this->session->has_userdata('suachua') && ($this->session->userdata('suachua')=='vinamilk'))
	{
		//redirect('tin/dangnhap','refresh')
 ?>
								...
								<div class="card-deck">
									<div class="card">
										...
										<div class="card-block">
											...
											<?= date('d/m/Y - G:i - A',$value['ngaytao']) ?> In <span class="vang"> <?= $value['tendanhmuc'] ?></span></small></p>
										</div>
									</div>
