				...
				<div class="col-sm-9">
					<div class="mottinchuan mb-3  wow  fadeInUp fontroboto">
						...
						<?php foreach ($dulieutin as $value) : ?>
							...
							<div class="ngaythang1"><?= date('d/m/Y - G:i - A', $value['ngaytao']) ?> In <span class="vang"> <?= $value['name'] ?></span></div>
						...
						<?php foreach ($tinlienquan as $value) : ?>
							...
							<div class="col-sm-4">
								<div class="card-deck-wrapper">
									<div class="card-deck">
										<div class="card">
											<a href="<?= base_url(); ?>/tintuc/chitiettin/<?= $value['id'] ?>"><img class="card-img-top img-fluid" src="<?= $value['anhtin'] ?>" alt="Card image cap"></a>
											<div class="card-block">
												...
												<p class="card-text"><small class="text-muted">
														<?= date('d/m/Y - G:i - A', $value['ngaytao']) ?> In <span class="vang"> <?= $value['name'] ?></span></small></p>
											</div>
										</div>
