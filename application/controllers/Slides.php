...
class Slides extends CI_Controller {
	...
	public function addSlide()
	{
		...
		// giai mã json 
		$dulieu = json_decode($dulieu,true); // true -> array()
		if($dulieu == null) {
	...
	public function suaSlide()
	{
		...
		$description = $this->input->post('description'); // day la mang 
		$button_text = $this->input->post('button_text'); // day la mang 
		$button_link = $this->input->post('button_link'); // day la mang 
	 	
		// lay ve that ca cac anh , roi upload len 
		$cacanh = $_FILES['slide_image']['name']; // mang luu tru ten cac file
